...
const realFileBtnCertificate = document.getElementById("real-file-certificate");
const customBtnCertificate = document.getElementById("custom-button-certificate");
const customTxtCertificate = document.getElementById("custom-text-certificate");

customBtnCertificate.addEventListener("click", function () {
  realFileBtnCertificate.click();
});
realFileBtnCertificate.addEventListener("change", function () {
  if (realFileBtnCertificate.value) {
    customTxtCertificate.innerHTML = realFileBtnCertificate.value.match(
      /[\/\\]([\w\d\s\.\-\(\)]+)$/
    )[1];
  } else {
    customTxtCertificate.innerHTML = "No file chosen, yet.";
  }
});
